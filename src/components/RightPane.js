                    ...
                    array
                        ...
                        .map((finalData) => (
                            <div className="rightpane__card">
                                ...
                                <textarea className="rightpane__cardTextField"
                                    type="text"
                                    value={textContent}
                                    onChange={(event) => {
                                ...
                                />
                                <div className="rightpane__cardDate">{weekday[finalData.date.getDay()]}, {finalData.date.getDate()}/ {finalData.date.getMonth()+1}</div>
