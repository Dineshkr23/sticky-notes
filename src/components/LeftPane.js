            ...
            <div className="leftpane__header">
                ...
                <Tooltip title="Add" aria-label="add">
                    <IconButton onClick={addContent}>
                        <AddIcon className="leftpane__headerIconButton" />
                    </IconButton>
                </Tooltip>
            </div>
                ...
                <div
                    ...
                    <div className="leftpane__contentData">
                        ...
                        <div className="leftpane__contentDataDate">
                            <div className="nohover">{weekday[data.date.getDay()]}, {data.date.getDate()}/ {data.date.getMonth() + 1}</div>
                            <div className="hover">
                        ...
                        <div className="leftpane__contentDataText">
                            {data.content}
                        </div>
                    </div>
                </div>
